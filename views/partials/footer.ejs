	...
	<footer class="bg-li py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="subscribe mx-auto">
				...
				<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">Signup today for our monthly newsletter to get to know of any updates and improvements of all our products.</p>
		...
		<div class="container-fluid">
			<div class="d-md-flex px-md-3 position-relative text-center">
				...
				<div class="copy_right mx-md-auto mb-md-0 mb-3">
					<p class="text-bl let">All rights reserved | Design by
						<a href="" target="_blank">SimplaTech Consulting Limited</a>
					</p>
				</div>
				<!-- //copyright -->
				<!-- move top icon -->
